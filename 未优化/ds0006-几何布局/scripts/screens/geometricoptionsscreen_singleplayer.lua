...
local GeometricOptionsScreen = Class(Screen, function(self)
	...
	for i,geometry in ipairs(geometries) do
		...
		local button = self.proot:AddChild(TEMPLATES.IconButton(
			"mods/ds0006/images/"..geometry_filename..".xml",
			--"mods/ds0006/images/"..geometry_filename..".tex",
	...
	for i,button in ipairs(toggle_buttons) do
		...
		local atlas = "mods/ds0006/images/"..button.name.."_toggle_icon.xml"
		--local texture = "mods/ds0006/images/"..button.name.."_toggle_icon.tex"
		local texture = button.name.."_toggle_icon.tex"
		local alt_atlas = "mods/ds0006/images/"..button.name.."_toggle_icon"..(button.name == "cursor" and "_num" or "")..".xml"
		--local alt_texture = "mods/ds0006/images/"..button.name.."_toggle_icon"..(button.name == "cursor" and "_num" or "")..".tex"
		...
		self[btn].image:SetTint(.5, 1, .5, 1)
		--self[btn].xout = self[btn]:AddChild(Image("mods/ds0006/images/toggle_x_out.xml", "mods/ds0006/images/toggle_x_out.tex"))
		self[btn].xout = self[btn]:AddChild(Image("mods/ds0006/images/toggle_x_out.xml", "toggle_x_out.tex"))
