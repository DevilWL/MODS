function swPerishable(component)
...
----------------------------------
				elseif owner and owner:HasTag("icestoreroom") then
					if not owner:HasTag("nocool") then
						inst.components.edible.temperatureduration = inst.components.edible.temperatureduration + TUNING.TEMP_STOREROOM_MULT
					end
----------------------------------
...
AddComponentPostInit("perishable", swPerishable)